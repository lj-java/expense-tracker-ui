const InputField = ({name, label, type, placeholder, max, min, error}) => {
  return (
    <div className='flex flex-col'>
      ...
      <input type={type} placeholder={placeholder} required max={max} min={min} className='border border-gray-300 bg-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500' name={name} />
